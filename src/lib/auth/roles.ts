...
const ADMIN_ROUTE_RULES: AdminRouteRule[] = [
  ...
  { prefix: "/admin/role-features", roles: ["admin"] as const },
  ...
  { prefix: "/admin/cogs/menu-breakdown", roles: ["manager"] as const },
  { prefix: "/admin/cogs/summary", roles: ["manager"] as const },
  { prefix: "/admin/cogs", roles: ["manager"] as const },
  { prefix: "/admin/transactions", roles: ["manager"] as const },
  { prefix: "/admin/cash-flow/bep", roles: ["manager"] as const },
  ...
  { prefix: "/admin/order-options", roles: ["manager"] as const },
